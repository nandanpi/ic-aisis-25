...
//                       IC-AISIS&apos;25 aspires to make a meaningful contribution
//                       to global efforts in sustainable development powered by
...
//                         },
//                         {
//                           title: "Encourage Original Research",
//                           description:
...
//                         </p>
//                         <p>
//                           The theme of IC-AISIS’25, {'"'}Harnessing AI to Drive
//                           Sustainability Across Industries{'"'} underscores the
//                           vital role of intelligent systems in accelerating the
//                           transition to a more sustainable future. Whether
//                           optimizing energy usage, enabling precision
//                           agriculture, improving healthcare delivery, or
//                           supporting resilient urban planning, AI technologies
//                           are reshaping every sector with smarter, more
//                           efficient, and environmentally conscious solutions.
//                         </p>
//                       </div>
//                     </div>
...
//                         launchpad for transformative ideas, impactful research,
//                         and actionable strategies that address pressing global
//                         needs through the power of AI.
//                       </p>
//                     </div>
//                   </div>
//                 ),
...
//                   India&apos;s respected statesmen, Late Justice
//                   K.S. Hegde—former Supreme Court Judge and Speaker
//                   of the Lok Sabha. The Trust was established with
//                   the mission of empowering rural youth through
...
//                   members and 2,175 support staff.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//               {
//                 title:
//                   "Nitte Centre for Intelligent Devices & Systems (N-CIDS)",
//                 description:
//                   "A leading research and innovation hub focused on advancing Artificial Intelligence (AI) and Data Science across diverse sectors such as healthcare, finance, education, manufacturing, and smart cities.",
//                 icon: (
//                   <Lightbulb className="w-8 h-8 text-blue-600" />
//                 ),
//               },
//               {
//                 title: "Association of Digital Engineering (ADE)",
//                 description:
//                   "A student-led technical society dedicated to fostering innovation, collaboration, and skill development in the field of digital technologies.",
//                 icon: <Users className="w-8 h-8 text-blue-600" />,
//               },
//               {
//                 title:
//                   "Master of Computer Applications (MCA) Department",
//                 description:
//                   "Offers a two-year postgraduate program established in 1993 with an annual intake of 180 students. Accredited by the National Board of Accreditation (NBA).",
//                 icon: <School className="w-8 h-8 text-blue-600" />,
//               },
//             ].map((org, index) => (
//               <div
//                 key={index}
//                 className="card-hover bg-white rounded-xl p-6 border border-gray-200 shadow-md flex flex-col h-full"
//               >
